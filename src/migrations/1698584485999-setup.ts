...
export class Setup1698584485999 implements MigrationInterface {
    name = 'Setup1698584485999'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE \`Ward\` (\`Id\` varchar(36) NOT NULL, \`Ward_Code\` varchar(100) NOT NULL, \`Ward_Name\` varchar(255) NOT NULL, \`Create_Date\` timestamp NULL DEFAULT CURRENT_TIMESTAMP, \`districtId\` char(36) NULL, \`cityId\` char(36) NULL, UNIQUE INDEX \`IDX_4be134f151488ae31a8263306b\` (\`Ward_Code\`), PRIMARY KEY (\`Id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`District\` (\`Id\` varchar(36) NOT NULL, \`District_Code\` varchar(100) NOT NULL, \`District_Name\` varchar(255) NOT NULL, \`Create_Date\` timestamp NULL DEFAULT CURRENT_TIMESTAMP, \`cityId\` char(36) NULL, UNIQUE INDEX \`IDX_08bdc6dc787ba82ce7e59c4cc8\` (\`District_Code\`), PRIMARY KEY (\`Id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`City\` (\`Id\` varchar(36) NOT NULL, \`City_Code\` varchar(100) NOT NULL, \`City_Name\` varchar(255) NOT NULL, \`Create_Date\` timestamp NULL DEFAULT CURRENT_TIMESTAMP, UNIQUE INDEX \`IDX_090de8cc080a13b95e31a0a520\` (\`City_Code\`), PRIMARY KEY (\`Id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`Address\` (\`Id\` varchar(36) NOT NULL, \`Address_Code\` varchar(100) NOT NULL, \`Address_1\` varchar(255) NULL, \`Address_2\` varchar(255) NULL, \`Address_3\` varchar(255) NULL, \`Is_Delete\` tinyint NULL DEFAULT '0', \`Create_Date\` timestamp NULL DEFAULT CURRENT_TIMESTAMP, \`cityId\` char(36) NULL, \`districtId\` char(36) NULL, \`wardId\` char(36) NULL, UNIQUE INDEX \`IDX_8d5ee169e3180495b27cecc483\` (\`Address_Code\`), PRIMARY KEY (\`Id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`Image\` (\`Id\` varchar(36) NOT NULL, \`Image_Code\` varchar(100) NOT NULL, \`Image_Name\` varchar(255) NOT NULL, \`Image\` longblob NULL, \`Image_Type\` int UNSIGNED NULL, \`Comment\` varchar(255) NULL, \`Is_Delete\` tinyint NULL DEFAULT '0', \`Create_Date\` timestamp NULL DEFAULT CURRENT_TIMESTAMP, \`Image_Default\` tinyint NULL DEFAULT '0', UNIQUE INDEX \`IDX_dcaa6ce0d1718339bb4f58f3d2\` (\`Image_Code\`), PRIMARY KEY (\`Id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`Shops\` (\`Id\` varchar(36) NOT NULL, \`Shop_Code\` varchar(100) NOT NULL, \`Shop_Name\` varchar(255) NOT NULL, \`Tax\` varchar(50) NULL, \`Telephone\` varchar(18) NULL, \`Telephone1\` varchar(18) NULL, \`Slogan\` varchar(100) NULL, \`Create_Date\` timestamp NULL DEFAULT CURRENT_TIMESTAMP, \`addressId\` char(36) NULL, UNIQUE INDEX \`IDX_03262247e2d1c7da92ed00a456\` (\`Shop_Code\`), UNIQUE INDEX \`REL_a225ab2c5f2f55d3ef516c8b79\` (\`addressId\`), PRIMARY KEY (\`Id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`Product_Color\` (\`Id\` varchar(36) NOT NULL, \`Color_Code\` varchar(100) NOT NULL, \`Color_Name\` varchar(255) NOT NULL, \`Comment\` varchar(255) NULL, \`Create_Date\` timestamp NULL DEFAULT CURRENT_TIMESTAMP, UNIQUE INDEX \`IDX_5250b830fdc3d284bddc03bbe4\` (\`Color_Code\`), PRIMARY KEY (\`Id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`Inventory\` (\`Id\` varchar(36) NOT NULL, \`Inventory_Date\` timestamp NULL, \`Created_By\` varchar(100) NULL DEFAULT 'admin', \`Create_Date\` timestamp NULL DEFAULT CURRENT_TIMESTAMP, \`Quantity\` decimal UNSIGNED NULL, \`Amount\` int UNSIGNED NULL, \`Price\` int UNSIGNED NOT NULL, \`Currenry\` varchar(30) NULL DEFAULT 'VND', \`Is_Delete\` tinyint NULL DEFAULT '0', \`productId\` char(36) NULL, \`shopId\` char(36) NULL, \`productColorId\` char(36) NULL, \`productSizeId\` char(36) NULL, PRIMARY KEY (\`Id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`Sales_Price\` (\`Id\` varchar(36) NOT NULL, \`Sale_Code\` varchar(255) NOT NULL, \`Sale_Price\` int UNSIGNED NOT NULL, \`Curcency\` varchar(100) NULL DEFAULT 'VND', \`Price_Date\` timestamp NULL, \`Created_By\` varchar(100) NULL DEFAULT 'admin', \`Create_Date\` timestamp NULL DEFAULT CURRENT_TIMESTAMP, \`Is_Delete\` tinyint NULL DEFAULT '0', \`Is_Active\` tinyint NULL DEFAULT '1', \`productId\` char(36) NULL, \`productSizeId\` char(36) NULL, UNIQUE INDEX \`IDX_337b9a908fb717d627d257c5a2\` (\`Sale_Code\`), PRIMARY KEY (\`Id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`Product_Size\` (\`Id\` varchar(36) NOT NULL, \`Size_Code\` varchar(100) NOT NULL, \`Size_Name\` varchar(255) NOT NULL, \`Comment\` varchar(255) NULL, \`Is_Delete\` tinyint NULL DEFAULT '0', \`Create_Date\` timestamp NULL DEFAULT CURRENT_TIMESTAMP, \`productId\` char(36) NULL, UNIQUE INDEX \`IDX_6f53f82ea2e89c0e08e4f5a633\` (\`Size_Code\`), PRIMARY KEY (\`Id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`CREATE TABLE \`Product_Category\` (\`Id\` varchar(36) NOT NULL, \`Category_Code\` varchar(100) NOT NULL, \`Category_Name\` varchar(255) NOT NULL, \`Create_Date\` timestamp NULL DEFAULT CURRENT_TIMESTAMP, \`Is_Active\` tinyint NULL DEFAULT '1', \`Is_Delete\` tinyint NULL DEFAULT '0', UNIQUE INDEX \`IDX_cb2b7b8da917f30f6b09015c89\` (\`Category_Code\`), PRIMARY KEY (\`Id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`Product\` (\`Id\` varchar(36) NOT NULL, \`Product_Code\` varchar(100) NOT NULL, \`Product_Name\` varchar(255) NOT NULL, \`Product_Type\` varchar(50) NULL, \`Product_Group\` varchar(50) NULL, \`Brand\` varchar(255) NULL, \`Comment\` varchar(255) NULL, \`Preserve\` varchar(255) NULL, \`Is_Delete\` tinyint NULL DEFAULT '0', \`Create_Date\` timestamp NULL DEFAULT CURRENT_TIMESTAMP, \`categoryProductId\` char(36) NULL, UNIQUE INDEX \`IDX_b83c942e4f059e9792af7c3934\` (\`Product_Code\`), PRIMARY KEY (\`Id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`Sales_Order\` (\`Id\` varchar(36) NOT NULL, \`Sale_Order_Code\` varchar(100) NOT NULL, \`Sale_Date\` timestamp NULL, \`Delivery_Date\` timestamp NULL, \`Created_By\` varchar(100) NULL DEFAULT 'admin', \`Create_Date\` timestamp NULL DEFAULT CURRENT_TIMESTAMP, \`Last_Update\` timestamp NULL, \`Quantity\` int UNSIGNED NULL, \`Amount\` int UNSIGNED NULL, \`Tax\` int UNSIGNED NULL DEFAULT '5', \`Transport_Fee\` tinyint NULL DEFAULT '0', \`Salesman\` varchar(100) NOT NULL DEFAULT 'admin', \`Is_Delete\` tinyint NULL DEFAULT '0', \`Is_Cancle\` tinyint NULL DEFAULT '0', \`status\` int NULL DEFAULT '1', \`productId\` char(36) NULL, \`productSizeId\` char(36) NULL, \`inventoryId\` char(36) NULL, \`customerId\` char(36) NULL, PRIMARY KEY (\`Id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`Customer\` (\`Id\` varchar(36) NOT NULL, \`Customer_Code\` varchar(100) NULL, \`Customer_Name\` varchar(255) NULL, \`Age\` decimal UNSIGNED NULL, \`Sex\` tinyint NULL DEFAULT '0', \`Job\` varchar(255) NULL, \`Telephone1\` varchar(18) NULL, \`Telephone2\` varchar(18) NULL, \`Is_Delete\` tinyint NULL DEFAULT '0', \`Create_Date\` timestamp NULL DEFAULT CURRENT_TIMESTAMP, \`addressId\` char(36) NULL, UNIQUE INDEX \`IDX_21c6210d53205f4bc2708cf7e3\` (\`Customer_Code\`), UNIQUE INDEX \`REL_bfcaf3bb2e68d276d27dc09715\` (\`addressId\`), PRIMARY KEY (\`Id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`Employee\` (\`Id\` varchar(36) NOT NULL, \`Employee_Code\` varchar(100) NOT NULL, \`Employee_Name\` varchar(255) NOT NULL, \`Sex\` char(10) NULL, \`Start_Date\` timestamp NULL, \`End_Date\` timestamp NULL, \`Birth_Day\` char(10) NULL, \`Position\` varchar(50) NULL, \`Is_Active\` tinyint NULL DEFAULT '1', \`Is_Delete\` tinyint NULL DEFAULT '0', \`Create_Date\` timestamp NULL DEFAULT CURRENT_TIMESTAMP, UNIQUE INDEX \`IDX_0f8a8c49cf37f4f7e1cd43fc5a\` (\`Employee_Code\`), PRIMARY KEY (\`Id\`)) ENGINE=InnoDB`);
